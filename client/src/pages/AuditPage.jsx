...
export default function AuditPage(){
    ...
    return(
        ...
        <h1 className="mt-4 text-4xl text-center mb-4">VERIFICATION PORTAL</h1>
        <div className="flex">
        <div className="mt-12 ml-20 grow flex items-center">
        <div className="mb-64">
        <h3 className="mt-2 text-2xl text-left mb-4">ENTER NFT</h3>
                    ...
                    <label className="border p-4 flex rounded-2xl gap-2 items-center">
                        <input type="button"  name="24/7 Camera"></input>
                            ...
                            <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
                                ...
                                <span>Switch URI (Must Be Owner)</span>
                            </label>
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                                <input type="button" onClick={handleToggle}></input>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className="mt-8">
                            {isToggled ? <input type="text" placeholder={'NFT Address'} />: ''}
                        </div>
